...
const Card2 = ({ img,caption ,name,date , field}) => {
    return (
            ...
            <Box sx={{height:"400px",mb:4,boxShadow:"rgba(2, 151, 157, 0.1) 0px 8px 24px",background:"rgba(80, 105, 126,0.6)","&:hover":{background:"rgb(80, 105, 126)",boxShadow:"rgba(2, 74, 157, 0.2) 0px 8px 24px",transform:"translateY(-5px)"},transition:"0.3s ease",textAlign:"center"}}>
